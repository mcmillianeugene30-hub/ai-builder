...
function GenerateButton({ prompt, disabled }: { prompt: string; disabled: boolean }) {
  return (
    <button
      ...
      style={{ backgroundColor: disabled ? '#475569' : '#0891b2', color: '#ffffff' }}
    >
...
export default function Home() {
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-slate-900 text-white" style={{ backgroundColor: '#020617', color: '#ffffff' }}>
        <div className="max-w-3xl mx-auto py-16 px-4">
          <h1 className="text-4xl font-bold text-center mb-2">AI App Generator</h1>
          <p className="text-slate-400 text-center mb-8" style={{ color: '#94a3b8' }}>Describe your app and get a full scaffold</p>
